<div id="bulls_auction" class="hide">     
  <form  class="form-horizontal" method="get" action="?action=edit_action">
    <fieldset>
      ...
      <div class="control-group">
        <label class="control-label" for="form"><? echo($texts['auction_bulls_form']); ?></label>
        <div class="controls">
          <input type="checkbox" id="form" name="form" />
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="auction_bulls_form_value"><? echo($texts['auction_bulls_form_entity']); ?></label>
        <div class="controls">
          <input type="text" id="auction_bulls_form_value" name="auction_bulls_form_value" placeholder="">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="autoform"><? echo($texts['auction_bulls_autoform']); ?></label>
        <div class="controls">
          <input type="checkbox" id="autoform" name="autoform" />
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" for="auction_bulls_autoform_value"><? echo($texts['auction_bulls_autoform_entity']); ?></label>
        <div class="controls">
          <input type="text" id="auction_bulls_autoform_value" name="auction_bulls_autoform_value" placeholder="">
        </div>
      </div>
      <span class="help-block"><? echo($texts['auction_bulls_calssification_hint']); ?></span><br/>
      <div class="control-group">
        <label class="control-label" for="auction_bulls_qs"><? echo($texts['auction_bulls_qs']); ?></label>
        <div class="controls">
          <select name="auction_bulls_qs"  id="auction_bulls_qs">
      ...
      <div class="control-group">
        <label class="control-label" for="auction_bulls_samonelle_state"><? echo($texts['auction_bulls_samonelle_state']); ?></label>
        <div class="controls">
          <select name="auction_bulls_samonelle_state"  id="auction_bulls_samonelle_state">
            <option value="0" ><? echo($texts['auction_bulls_samonelle_state_unkown']); ?></option>
            <option value="1" ><? echo($texts['auction_bulls_samonelle_state_1']); ?></option>
            <option value="2" ><? echo($texts['auction_bulls_samonelle_state_2']); ?></option>
            <option value="3" ><? echo($texts['auction_bulls_samonelle_state_3']); ?></option>
          </select>
        </div>
      </div>
      <div class="control-group">
...
$("#bulls_auction #auction_submit").click(function(){
	
	errorflag=false;
	$("#bulls_auction #error_message").empty();
	
		if($("#auction_amount").val()==''){
	
		$("#bulls_auction #error_message").append('<? echo($texts['auction_amount_error']); ?><br/>');
		errorflag=true;
		...
		$("#bulls_auction #error_message").append('<? echo($texts['auction_min_entitity_price_error']); ?><br/>');
		errorflag=true;
		...
		$("#bulls_auction #error_message").append('<? echo($texts['auction_origin_error']); ?><br/>');
		errorflag=true;
		...
		if(($("#form").is(':checked')) && $("#auction_bulls_form_value").val()==''){
		
		
		$("#bulls_auction #error_message").append('<? echo($texts['auction_bulls_form_value_error']); ?><br/>');
		errorflag=true;

		}
	 
	 	if(($("#autoform").is(':checked')) && $("#auction_bulls_autoform_value").val()==''){
		
		
		$("#bulls_auction #error_message").append('<? echo($texts['auction_bulls_autoform_value_error']); ?><br/>');
		errorflag=true;
		...
		$("#bulls_auction #error_message").append('<? echo($texts['auction_loading_stations_distance_error']); ?><br/>');
		errorflag=true;
		...
		$("#bulls_auction #error_message").append('<? echo($texts['auction_loading_stations_availability_error']); ?><br/>');
		errorflag=true;
