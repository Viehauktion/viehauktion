...
$texts['navi_register']="Registrieren";
$texts['navi_login']="Anmelden";
...
$texts['auction_seller']="Verkäufer";

$texts['auction_details']="Details aufrufen";
...
$texts['change_password_description']="Geben Sie bitte Ihr neu gewähltes Password ein und bestätigen Sie die Änderung durch Eingabe des alten Passwortes.";
$texts['change_password_submit']="Passwort ändern";

$texts['change_password_new_password']="Neues Passwort";
$texts['change_password_new_password_again']="Neues Passwort wiederholen";
$texts['change_password_old_password']="Altes Passwort zur Bestätigung";

$texts['change_password_error_password']="Bitte geben Sie ein neues mindesten 4 stelliges Passwort ein.";
$texts['change_password_error_password_again']="Bitte wiederholen Sie ihr neues Passwort";
$texts['change_password_error_password_dont_match']="Ihre Passwörter stimmen leider nicht überein.";
$texts['change_password_error_old_password']="Bitte geben Sie ihr altes Passwort zur Bestätigung ein.";
$texts["change_password_success"]="Ihr Password wurde erfolgreich geändert.";
$texts['change_password_wrong_password_error']="Ihr altes Password war nicht korrekt. Das Passwort wurde nicht geändert.";
...
$texts['vehicle_1']="Jedem Fahrzeug";
$texts['vehicle_2']="Motorwagen ohne Anhänger";
$texts['vehicle_3']="Motorwagen mitAnhänger";
$texts['vehicle_4']="Sattelzug";

$texts['state']="Bundesland";
$texts['county']="Landkreis";
$texts['auction_mask']="Landkreis";

$texts['auction_id']="Auktionsnummer";
...
$texts['select_running_auction_submit']="Zur Live-Auktion gelangen";
...
Dabei macht ein Anbieter Angaben zur Anzahl der Tiere, deren Herkunft, Ihres Samonellen Status und des QS.<br/> 
Darüberhinaus gibt er die Stalladresse an, die während der Auktion allerdings nur als Ortschaft ausgegeben wird.<br/> <br/>
Anbieter können Ihre Tiere komplett anonym, teilweise anonym (durch Freigabe des Benutzernamens) oder öffentlich anbieten.<br/> 
Auktionen finden jeweils nacheinaneder pro Landkreis statt.<br/> 
Die Auktionszeit beträgt 2 Minuten, erhöht sich aber jeweils um bis zu 30 Sekunden, wenn in den letzten 30 Sekunden noch ein Gebot reinkommt.<br/> <br/>
Den Zuschlag erhält der Bieter mit dem höchsten Gebot der jeweiligen Auktion.<br/> 
Das aktuell höchste Gebot kann live auf viehauktion.com verfolgt werden<br/> <br/>
Alle angemeldeten Käufer auf Viehauktion.com besitzen eine Warenversicherung.<br/> 
Im Anschluss jeder Auktion erhält sowohl der Verkäufer als auch der Käufer eine E-Mail mit allen notwendigen Angaben zur erfolgreichen Auktion.<br/> 
Diese Angaben kann jeder auch nachträglich in seinem Profil abrufen.<br/> 
Anbieter können Ihre Tiere auch außerhalb einer Auktion im Markplatzbereich zum Festpreis pro Kilogramm anbieten.<br/> <br/>
Hier erhält derjenige Käufer den Zuschlag, der als erster das Angebot verbindlich kauft.<br/> <br/>
Auch hierbei werden erst im Falle eines Kaufes die Vertragsdaten zwischen den Parteien ausgetauscht.<br/> 
Viehauktion.com nimmt in beiden Fällen eine Provision vom Anbieter von 0,40 € (Mehrwertsteuer inkl.) pro Tier.<br/> <br/>
...
$texts['contact_email_error']="Bitte geben Sie eine korrekte E-Mailadresse ein.";
$texts['contact_message_error']="Bitte geben Sie eine Nachricht ein.";
